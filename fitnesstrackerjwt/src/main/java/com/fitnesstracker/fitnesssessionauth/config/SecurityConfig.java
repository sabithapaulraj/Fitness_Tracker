...
import com.fitnesstracker.fitnesssessionauth.filter.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/plans/**").hasRole("TRAINER")
                        .requestMatchers("/api/user/**").hasAnyRole("USER", "TRAINER", "ADMIN")
                        .requestMatchers("/dashboard/**").hasAnyRole("USER", "TRAINER", "ADMIN")
